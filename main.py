...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","ll_about_ari_ll")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","lll_notookk_lll")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","three_stars_ki_duniya")
...
**ᴍᴀᴅᴇ ᴡɪᴛʜ ❣️ ʙʏ || [ᴀʀɪ](https://t.me/lll_notookk_lll)||**
"""
SOURCE_TEXT = f"""
**๏ ʜᴇʏ, ɪ ᴀᴍ [{BOT_NAME}]
➻ ᴀɴ ᴀɪ-ʙᴀsᴇᴅ ᴄʜᴀᴛʙᴏᴛ.
...
SOURCE = 'https://t.me/ll_about_ari_ll'
x=["❤️","🥰","✨","💖","🎉","❤️‍🔥","💫"]
g=choice(x)
